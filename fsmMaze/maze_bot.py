...
class MazeBot:
    ...
    def add_state_transitions(self):
        ...
        self.fsm.add_transition("X", "BS", self.move_south, "BS")
        self.fsm.add_transition("X", "BE", self.move_east, "BE")
        self.fsm.add_transition("X", "BN", self.move_north, "BN")
        self.fsm.add_transition("X", "BW", self.move_west, "BW")

        self.fsm.add_transition("$", "BS", None, "FIN")
        self.fsm.add_transition("$", "BE", None, "FIN")
        self.fsm.add_transition("$", "BN", None, "FIN")
        self.fsm.add_transition("$", "BW", None, "FIN")

        self.fsm.add_transition("$", "NS", None, "FIN")
        self.fsm.add_transition("$", "NE", None, "FIN")
        self.fsm.add_transition("$", "NN", None, "FIN")
        self.fsm.add_transition("$", "NW", None, "FIN")

        self.fsm.add_transition(" ", "BS", self.move_south, "BS")
        self.fsm.add_transition(" ", "BE", self.move_east, "BE")
        self.fsm.add_transition(" ", "BN", self.move_north, "BN")
        self.fsm.add_transition(" ", "BW", self.move_west, "BW")

        self.fsm.add_transition(" ", "NS", self.move_south, "NS")
        self.fsm.add_transition(" ", "NE", self.move_east, "NE")
        self.fsm.add_transition(" ", "NN", self.move_north, "NN")
        self.fsm.add_transition(" ", "NW", self.move_west, "NW")
